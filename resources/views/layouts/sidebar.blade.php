<div class="h-screen p-3 z-10 space-y-2  dark:bg-gray-900 dark:text-gray-100 lg:sticky lg:block hidden top-0 sidebar transition transition-all -translate-x-full lg:translate-x-0">
    ...
    <div class="divide-y divide-gray-700">
        <ul class="pt-2 pb-4 space-y-1 text-sm">
            ...
            <li>
                <a rel="noopener noreferrer" href="{{ route('fraiss.index') }}" class="flex items-center p-2 space-x-3 rounded-md">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="w-5 h-5 fill-current dark:text-gray-400">
            ...
            <li>
                <a rel="noopener noreferrer" href="{{ route('eleves.index') }}" class="flex items-center p-2 space-x-3 rounded-md">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-person dark:text-gray-400" viewBox="0 0 16 16">
                <path d="M8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6Zm2-3a2 2 0 1 1-4 0 2 2 0 0 1 4 0Zm4 8c0 1-1 1-1 1H3s-1 0-1-1 1-4 6-4 6 3 6 4Zm-1-.004c-.001-.246-.154-.986-.832-1.664C11.516 10.68 10.289 10 8 10c-2.29 0-3.516.68-4.168 1.332-.678.678-.83 1.418-.832 1.664h10Z"/>
                </svg>
                    <span>Eleves</span>
                </a>
            ...
            <li>
                <a rel="noopener noreferrer" href="{{ route('options.index') }}" class="flex items-center p-2 space-x-3 rounded-md">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-option" viewBox="0 0 16 16">
            ...
            <li>
                <a rel="noopener noreferrer" href="{{ route('promotions.index') }}" class="flex items-center p-2 space-x-3 rounded-md">
              ...
              <li>
                <a rel="noopener noreferrer" href="{{ route('sections.index') }}" class="flex items-center p-2 space-x-3 rounded-md">
            ...
            <li>
                <a rel="noopener noreferrer" href="{{ route('paiements.store') }}" class="flex items-center p-2 space-x-3 rounded-md">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-cart dark:text-gray-400" viewBox="0 0 16 16">
